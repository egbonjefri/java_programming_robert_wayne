 ...
 public final class In {
    ...
    /**
     ...
     public Object readObject() {
        ...
        if (token == null) {
            throw new NoSuchElementException("Reading from empty input");
        }

        // Try to parse the token as different types
        try {
        ...
        // If it's not any of the above types, return it as a String
        return token;
    }
     /**
