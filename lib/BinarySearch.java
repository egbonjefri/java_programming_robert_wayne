 ...
 ******************************************************************************/
 ...
 public class BinarySearch {
     ...
     public static boolean binarySearch(int[] arr, int target, int left, int right, boolean isAscending) {
        if (left > right) {
            return false;
        }
        ...
        if ((isAscending && arr[mid] < target) || (!isAscending && arr[mid] > target)) {
            return binarySearch(arr, target, mid + 1, right, isAscending);
        } else {
            return binarySearch(arr, target, left, mid - 1, isAscending);
        }
    }
     /**
