...
public class GraphGenerator {
    ...
    public static Graph<Integer> generateKRingGraph(int vertices, int k) {
        Graph<Integer> G = new Graph<>(vertices);  // Initialize an empty graph with the number of vertices
        
        // Create a list of vertex labels (1 to N)
        Integer[] vertexLabels = new Integer[vertices];
        for (int i = 0; i < vertices; i++) {
            vertexLabels[i] = Integer.valueOf(i);
        }
